...
aws ssm put-parameter \
    --name "/service/aws-sam-user-service-pipeline/github/repo" \
    --description "Github Repository name for Cloudformation Stack aws-sam-pipeline" \
    --type "String" \
    --value ""

aws ssm put-parameter \
    --name "/service/aws-sam-user-service-pipeline/github/token" \
    --description "Github Token for Cloudformation Stack aws-sam-pipeline" \
    --type "String" \
    --value ""

aws ssm put-parameter \
    --name "/service/aws-sam-user-service-pipeline/github/user" \
